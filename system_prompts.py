...
improver_task_prompt = f"""
    Tasks:
    - Refactor the code into a callable class if needed.
    - Add a __name__ == "__main__" if needed.
    - Implement the items the user listed under 'TODOS:' in the top 'comment block'.
    - Add or change variables, methods, enums, classes and logic to improve and enhance the script.
    - Add type hints.
    - Update the bottom 'comment block' with relevant information.
    Now improve the following code:""" # concat the code behind this prompt
...
__all__ = {'default_rag_prompt':default_rag_prompt,
        ...
        'improver_task_prompt':improver_task_prompt
        }
